...
import { ArrowUp, ArrowDown, MessageCircle, MoreHorizontal, Send } from 'lucide-react';
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
            <span className="font-medium">u/{comment.username || 'Anonymous'}</span>
            <span>•</span>
...
export default function CommentSection({ postId }: CommentSectionProps) {
  const { comments, loading, error, refetch } = useComments(parseInt(postId));
