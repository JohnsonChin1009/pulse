...
export function TeamSection() {
  const teamMembers = [
    {
      ...
      role: "Single & Looking for GF",
      image: "/images/johnson.png",
      bio: "I bully kids",
      traits: ["German Worshipper"],
  ...
  return (
    <section id="team" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="text-center mb-16">
          <h2 className="font-montserrat font-bold text-3xl sm:text-4xl text-gray-900 mb-4">Our <span className="text-[#F5BE66]">Team</span></h2>
          <p className="font-montserrat text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Meet the passionate professionals behind Pulse, combining medical expertise with innovative technology to
            revolutionize heart health education.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <h3 className="font-dela-gothic text-lg text-gray-900 mb-1">{member.name}</h3>
              <p className="font-montserrat text-[#F5BE66] font-medium text-sm mb-3">{member.role}</p>
              <p className="font-montserrat text-gray-600 text-sm leading-relaxed mb-4">{member.bio}</p>
